...
export default function GroupDetail() {
  ...
  return (
    <div>
      <header className="sticky top-0 z-30 px-5 pt-[calc(env(safe-area-inset-top,0px)+1rem)] pb-2 mb-3 flex items-center justify-between gap-4 bg-background/70 backdrop-blur-xl">
