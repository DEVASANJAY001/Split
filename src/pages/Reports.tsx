      ...
      <div className="px-5 space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <SurfaceCard padding="md">
            ...
            <p className="text-2xl font-bold tracking-tightest text-ink tabular-nums mt-1">{fmt(total, cur)}</p>
          </SurfaceCard>
          <SurfaceCard padding="md">
            <p className="text-xs text-ink-soft">You paid</p>
            <p className="text-2xl font-bold tracking-tightest text-ink tabular-nums mt-1">{fmt(myPaid, cur)}</p>
          </SurfaceCard>
        </div>
            ...
            <ul className="mt-3 grid grid-cols-2 gap-x-4 gap-y-2">
              {byCategory.map((c) => (
                <li key={c.name} className="flex items-center gap-2 text-xs">
                  ...
                  <span className="font-semibold text-ink tabular-nums">{fmt(c.value, cur)}</span>
                </li>
              ))}
            </ul>
          </SurfaceCard>
